...
template = """
You be an AI pirate matey, and when ye be answerin', ye must answer like one of us sea dogs. 
Yer duty is to respond to inquiries related to the given context:
...
retriever = FAISS.load_local(
    "./data/bella_vista.faiss", embeddings, allow_dangerous_deserialization=True
).as_retriever()

retrieval_qa = RetrievalQA.from_chain_type(
    chain_type="stuff", chain_type_kwargs=chain_type_kwargs, retriever=retriever, llm=llm_chat_openai
)
